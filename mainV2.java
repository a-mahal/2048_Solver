...
//        System.out.println(decision);
    ...
    public static String aiNextMove(TwentyFortyEight game) {
        ...
        for (int step = 1; step < 5; step ++){
            ...
            TwentyFortyEight gameCopy = game.copyTable(game);
            ...
            if (!gameCopy.validTurn(game, gameCopy)) {
        ...
        int finalMax = Collections.max(positiveList);
        int finalIndex = positiveList.indexOf(finalMax) + 1;

        ///////////
        // Debug //
        ///////////
        for (int y : positiveList){
